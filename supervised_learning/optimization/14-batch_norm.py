...
def create_batch_norm_layer(prev, n, activation):
    ...
    layer = tf.keras.layers.Dense(units=n, kernel_initializer=kernel_initializer, activation=None)(prev)
    ...
    normalized = tf.nn.batch_normalization(layer, mean, variance, beta, gamma, epsilon)
