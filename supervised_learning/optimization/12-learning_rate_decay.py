...
def learning_rate_decay(alpha, decay_rate, global_step, decay_step):
    ...
    Args:
        ...
        global_step: The TensorFlow variable representing the number of passes of gradient descent that have elapsed.
    ...
    """
    updated_alpha = tf.train.inverse_time_decay(alpha, global_step, 
